...
const ListRoom = () => {
  ...
  return (
    <div>
      ...
      rounded-lg max-h-80 overflow-y-scroll mt-4"
      >
          ...
          <tbody className="text-sm">
            {rooms.map((item, index) => (
              <tr key={index}>
                ...
                <td
                  className="py-3 px-4 text-red-500 border-gray-300 border-t 
                text-sm text-center "
                >
                  <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3 ">
                    <input
                      ...
                      checked={item.isAvaiable}
                    />
                    <div
                      className="w-12 h-7 bg-slate-300 rounded-full
                     peer peer-checked:bg-blue-600 transition-colors duration-200"
                    >
                      {" "}
                    </div>
                    <span
